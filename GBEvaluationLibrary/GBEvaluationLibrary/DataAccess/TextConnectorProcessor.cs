...
/// </summary>
    ...
    {/// <summary>
     /// This static method returns file name along with its path. Path is collected from app.config file
     /// </summary>
     /// <param name="fileName"></param>
     /// <returns></returns>
        public static string GetFullFilePath(this string fileName) //GBsamples.csv
        {
